...
1) С генерацией html отчета (реализовано через pytest-html, Allure прикрутить не успел) 
...
Файл с отчетом в формате .html генерируется в директории автотестов, в корневой папке exercise_2 
